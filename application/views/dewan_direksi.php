...
<body>
  <div id="responsive1">
    ...
    <?php
            foreach ($gambardirek->result_array() as $row) {
                $foto = $row['gambar'];
...
<div id="isi">
    ...
    <div style="padding-bottom:25px;">
        ...
        <?php 
        foreach ($juduldirek->result_array() as $row) {
	...
	<div id="posting2">
    <?php
            foreach ($ambildireksi->result_array() as $row) {
                $foto = $row['gambar'];
                echo "<div style='min-width:20%; float:left;'>";
                echo "<img src='".base_url()."asset/foto_berita/".$foto."'>";
                echo "</div>";
            
                echo "<div style='max-width:80%; float:left'>";
                echo "<h1 class='judul'>$row[judul_berita]</h1>"; 

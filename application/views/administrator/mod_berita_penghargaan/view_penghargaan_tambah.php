    ...
    echo "<div class='col-md-12'>
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Penghargaan dan Sertifikasi Baru</h3>
                  <p style='color: red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/tambah_penghargaan',$attributes); 
              echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Jenis<span style='color : red'> *</span></th>               
                    <td><input type='radio' name='d' value='penghargaan'> Penghargaan &nbsp; 
                    <input type='radio' name='d' value='sertifikasi'> Sertifikasi</td></tr>
                    
                    <tr><th scope='row'>Isi Berita<span style='color : red'> *</span></th>             
                    <td><textarea id='editor1' class='form-control' name='e' style='height:320px' required></textarea></td></tr>

                    <tr><th scope='row'>Gambar<span style='color : red'> *</span></th>                 
                    <td><input type='file' class='form-control' name='f'></td></tr>
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Input New Award and Certification</h3>
              ...
              echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <td><input type='text' class='form-control' name='i' required></td></tr>

                    
                    <tr><th scope='row'>Type<span style='color : red'> *</span></th>               
                    <td><input type='radio' name='j' value='penghargaan'> Award &nbsp; 
                    <input type='radio' name='j' value='sertifikasi'> Certification</td></tr>
                    
                    <tr><th scope='row'>News Content<span style='color : red'> *</span></th>             
                    <td><textarea id='editor2' class='form-control' name='k' style='height:320px' required></textarea></td></tr>

                    <tr><th scope='row'>Picture<span style='color : red'> *</span></th>                 
                    <td><input type='file' class='form-control' name='l'></td></tr>

      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            echo "<div class='col-md-12'>
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Penghargaan/Sertifikasi Terpilih</h3>
                  <br>
                        <p style='color:red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/edit_penghargaan',$attributes); 
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$penghargaan[id_penghargaan]'>

                    <tr><th scope='row'>Tahun</th>               
                    <td><select name='b' class='form-control' required>
                    <option value='' selected>- Pilih Tahun -</option>";
                      foreach ($tahun->result_array() as $row){
                        if ($penghargaan['tahun'] == $row['tahun']){
                    ...
                    <td><input type='text' class='form-control' name='c' value='$penghargaan[judul_penghargaan]' required></td></tr>

                     <tr><th scope='row'>Jenis</th>               
                    <td>"; if($penghargaan['jenis']=='penghargaan'){ echo "<input type='radio' name='d' value='penghargaan' checked> Penghargaan &nbsp; 
                      <input type='radio' name='d' value='sertifikasi'> Sertifikasi"; }else{ echo "<input type='radio' name='d' value='penghargaan'> Penghargaan &nbsp; 
                      <input type='radio' name='d' value='sertifikasi' checked> Sertifikasi"; } echo"</td></tr>
                    
                    <tr><th scope='row'>Isi Berita</th>             
                    <td><textarea id='editor1' class='form-control' name='e' style='height:320px' required>$penghargaan[isi]</textarea></td></tr>

                    <tr><th scope='row'>Ganti Gambar</th>                 
                    <td><input type='file' class='form-control' name='f'>";
                      if ($penghargaan['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href='".base_url()."asset/foto_berita/$penghargaan[gambar]'>$penghargaan[gambar]</a>"; } echo "</td></tr>
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Selected Achievement/Certification</h3>
                  <br>
              ...
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$penghargaan_en[id_penghargaan]'>

                    <tr><th scope='row'>Year</th>               
                    <td><select name='g' class='form-control' required>
                    <option value='' selected>- Select Year -</option>";
                      foreach ($tahun->result_array() as $row){
                        if ($penghargaan_en['tahun'] == $row['tahun']){
                          echo "<option value='$row[tahun]' selected>$row[tahun]</option>";
                        }else{
                          echo "<option value='$row[tahun]'>$row[tahun]</option>";
                        }
                    ...
                    <tr><th width='120px' scope='row'>Title</th>    
                    <td><input type='text' class='form-control' name='h' value='$penghargaan_en[judul_penghargaan]' required></td></tr>


                    <tr><th scope='row'>Type</th>               
                    <td>"; if($penghargaan_en['jenis']=='penghargaan'){ echo "<input type='radio' name='z' value='penghargaan' checked> Award &nbsp; 
                      <input type='radio' name='z' value='sertifikasi'> Certification"; }else{ echo "<input type='radio' name='z' value='penghargaan'> Award &nbsp; 
                      <input type='radio' name='z' value='sertifikasi' checked> Certification"; } echo"</td></tr>
                    
                    <tr><th scope='row'>News Content</th>             
                    <td><textarea id='editor2' class='form-control' name='j' style='height:320px' required>$penghargaan_en[isi]</textarea></td></tr>

                    <tr><th scope='row'>Change Image</th>                 
                    <td><input type='file' class='form-control' name='k'>";
                      if ($penghargaan_en['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href='".base_url()."asset/foto_berita/$penghargaan_en[gambar]'>$penghargaan_en[gambar]</a>"; } echo "</td></tr>
            ...
            <div class='box-footer'>
                    ...
                    <a href='../berita_penghargaan'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
            </div>
            </div>"; ?>
        </section>

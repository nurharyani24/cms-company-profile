          ...
          <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Semua Berita Tanggung Jawab Sosial</h3>
                  <a class='pull-right btn btn-danger' href='<?php echo base_url(); ?>administrator/tambah_berita_tanggungjwb'>Tambahkan Data</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$tgl_posting</td>
                              <td><center>
                                <a class='btn btn-success btn-xs' title='Edit Data' href='".base_url()."administrator/edit_berita_tanggungjwb/$row[id_berita]'><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."administrator/delete_berita_tanggungjwb/$row[id_berita]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>
                          </tr>";
                      $no++;
                    }

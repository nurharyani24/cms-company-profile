      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            echo "<div class='col-md-12'>
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Tanggung Jawab Sosial Terpilih</h3>
                  <br>
                        <p style='color:red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/edit_berita_tanggungjwb',$attributes); 
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$brt[id_berita]'>
                    ...
                    <td><textarea class='form-control' name='c' style='height:320px' required>$brt[keterangan]</textarea></td></tr>

                    <tr><th scope='row'>Ganti Gambar</th>                 
                    <td><input type='file' class='form-control' name='d'>";
                      if ($brt['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href='".base_url()."asset/foto_berita/$brt[gambar]'>$brt[gambar]</a>"; } echo "</td></tr>
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Selected Corporate Social Responsibility</h3>
                  <br>
              ...
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$brt_en[id_berita]'>
                    ...
                    <td><textarea class='form-control' name='f' style='height:320px' required>$brt_en[keterangan]</textarea></td></tr>

                    <tr><th scope='row'>Change Image</th>                 
                    <td><input type='file' class='form-control' name='g'>";
                      if ($brt_en['gambar'] != ''){ echo "<i style='color:red'>View current image: </i><a target='_BLANK' href='".base_url()."asset/foto_berita/$brt_en[gambar]'>$brt_en[gambar]</a>"; } echo "</td></tr>
            ...
            <div class='box-footer'>
                    ...
                    <a href='../berita_tanggungjwb'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
            </div>
          </div>"; ?>
        </section>

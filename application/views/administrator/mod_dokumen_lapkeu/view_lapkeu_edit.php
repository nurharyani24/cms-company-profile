    ...
    echo "<div class='col-md-12'>
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Laporan Keuangan Terpilih</h3>
                  <br>
                        <p style='color:red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/edit_lapkeu',$attributes); 
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$dokumen[id_lapkeu]'>

                    <tr><th width='120px' scope='row'>Bulan</th>    
                    <td><input type='number' class='form-control' name='b' value='$dokumen[keterangan]' required></td></tr>
                    ...
                    <td><input type='file' class='form-control' name='e'>";
                      if ($dokumen['dokumen'] != ''){ echo "<i style='color:red'>Lihat Dokumen Saat ini : </i><a target='_BLANK' href='".base_url()."asset/laporan_keuangan/$dokumen[dokumen]'>$dokumen[dokumen]</a>"; } echo "</td></tr>
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Selected Financial dangerrmation</h3>
                  <br>
              ...
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$dokumen_en[id_lapkeu]'>

                    <tr><th width='120px' scope='row'>Month</th>    
                    <td><input type='number' class='form-control' name='z' value='$dokumen_en[keterangan]' required></td></tr>
                    
                    <tr><th scope='row'>Year</th>               
                    <td><select name='x' class='form-control' required>
                    ...
                    <td><input type='file' class='form-control' name='w'>";
                      if ($dokumen_en['dokumen'] != ''){ echo "<i style='color:red'>View current document : </i><a target='_BLANK' href='".base_url()."asset/laporan_keuangan/$dokumen_en[dokumen]'>$dokumen_en[dokumen]</a>"; } echo "</td></tr>
            ...
            <div class='box-footer'>
                    ...
                    <a href='../lapkeu'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
            </div>
          </div>"; ?>
        </section>

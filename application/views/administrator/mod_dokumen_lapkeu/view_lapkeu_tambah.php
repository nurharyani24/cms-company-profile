            ...
            echo "<div class='col-md-12'>
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Laporan Keuangan Baru</h3>
                  <p style='color: red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/tambah_lapkeu',$attributes); 
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='120px' scope='row'>ID Laporan<span style='color : red'> *</span></th> 
                    <td><input type='number' class='form-control' name='a' required></td></tr>

                    <tr><th width='120px' scope='row'>Bulan<span style='color : red'> *</span></th> 
                    <td><input type='number' class='form-control' name='b' required></td></tr>
                    ...
                    <tr><th scope='row'>Dokumen<span style='color : red'> *</span></th>                 
                    <td><input type='file' class='form-control' name='e'></td></tr>
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Add Financial Statement</h3>
              ...
              echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Month<span style='color : red'> *</span></th> 
                    <td><input type='number' class='form-control' name='g' required></td></tr>
                    ...
                    <tr><th scope='row'>Document<span style='color : red'> *</span></th>                 
                    <td><input type='file' class='form-control' name='i'></td></tr>

  ...
  .sekolah:hover{
    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <input type='hidden' name='id' value='$menu1[id_main]'>
                    <tr><th width='120px' scope='row'>Nama Menu</th>   <td><input type='text' class='form-control' name='a' value='$menu1[nama_menu]'></td></tr>
                    <tr><th scope='row'>Link</th>                 <td><input type='text' class='form-control' name='b' value='$menu1[link]'></td></tr>
                    ...
                    echo "</td></tr>
                    <tr><th scope='row'>Admin Menu</th>                  
                    <td>"; if ($menu1['admin_menu'] == 'Y'){
          ...
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$menu2[id_main]'>
                    <tr><th width='120px' scope='row'>Menu Name</th>   
                    <td><input type='text' class='form-control' name='f' value='$menu2[nama_menu]'></td></tr>
                    <tr><th scope='row'>Link</th>                 
                    <td><input type='text' class='form-control' name='g' value='$menu2[link]'></td></tr>
                    
                    <tr><th scope='row'>Active</th><td>"; 
                    if ($menu2['aktif'] == 'Y'){
                      echo "<input type='radio' name='h' value='Y' checked> Y 
                        <input type='radio' name='h' value='N'> N";
                    }else{
                      echo "<input type='radio' name='h' value='Y'> Y 
                        <input type='radio' name='h' value='N' checked> N";
                    }
                    echo "</td></tr>
                    <tr><th scope='row'>Admin Menu</th>                  
                    <td>"; if ($menu2['admin_menu'] == 'Y'){
                      echo "<input type='radio' name='i' value='Y' checked> Y 
                        <input type='radio' name='i' value='N'> N";
                      }else{
                        echo "<input type='radio' name='i' value='Y'> Y 
                        <input type='radio' name='i' value='N' checked> N";
                      }
                    echo "</td></tr>
                  </tbody>
                  </table>
            ...
            <div class='box-footer'>
                    ...
                    <a href='../menuutama'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
            </div>
          </div>"; ?>
        </section>

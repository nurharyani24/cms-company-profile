    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Nama Menu<span style='color : red'> *</span></th>  
                    ...
                    <td><input type='radio' name='c' value='Y'> Y <input type='radio' name='c' value='N'> N</td></tr>
                    <tr><th scope='row'>Admin Menu<span style='color : red'> *</span></th>               
                    <td><input type='radio' name='d' value='Y'> Y <input type='radio' name='d' value='N'> N</td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Add Main Menu</h3>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Menu Name<span style='color : red'> *</span></th>  
                    ...
                    <td><input type='radio' name='g' value='Y'> Y <input type='radio' name='g' value='N'> N</td></tr>
                    <tr><th scope='row'>Admin Menu<span style='color : red'> *</span></th>               
                    <td><input type='radio' name='h' value='Y'> Y <input type='radio' name='h' value='N'> N</td></tr>
                  </tbody>
                  </table>
                </div>
              </div>

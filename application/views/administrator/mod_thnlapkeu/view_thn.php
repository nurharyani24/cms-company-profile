  ...
  .sekolah:hover{
    color:#fff;
        ...
        <a href="home" class="logo">
          ...
          <span class="logo-lg"><img width="35px" height="35px" src="<?=base_url()?>images/header-logo.png" ><b> CMS MDIA</b></span></a>
          ...
          <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  ...
                  <a class='pull-right btn btn-danger' href='<?php echo base_url(); ?>administrator/tambah_tahun_lapkeu'>Tambahkan Data</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                      ...
                      echo "<tr><td>$no</td>
                              <td>$row[tahun]</td>
                               <td><center>
                                ...
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."administrator/delete_tahun_lapkeu/$row[tahun]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>
                          </tr>";
                      $no++;
                    }

          ...
          <?php echo "<div class='col-md-12'>
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Tahun Laporan Keuangan</h3>
                  <p style='color: red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/tambah_tahun_lapkeu',$attributes); 
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='120px' scope='row'>Tahun<span style='color : red'> *</span></th>    
              ...
              <div class='box-footer'>
                    ...
                    <a href='tahun_lapkeu'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>

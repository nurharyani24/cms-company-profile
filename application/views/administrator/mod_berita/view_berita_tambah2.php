    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <td><textarea id='editor1' class='form-control' name='d' style='height:320px' required></textarea></td></tr>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <td><input type='text' class='form-control' name='g' required></td></tr>
                    ...
                    <td><textarea id='editor2' class='form-control' name='j' style='height:320px' required></textarea></td></tr>

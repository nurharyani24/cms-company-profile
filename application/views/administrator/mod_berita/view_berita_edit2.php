        ...
        <section class="content">
          ...
          echo "<div class='col-md-12'>
                  ...
                  echo "<div class='col-md-12'>
                    <table class='table table-condensed table-bordered'>
                      ...
                      <input type='hidden' name='id' value='$berita[id_berita]'>
                        <tr><th width='120px' scope='row'>Judul Berita</th>    
                        <td><input type='text' class='form-control' name='a' value='$berita[judul_berita]' required></td></tr>
                        <tr><th scope='row'>Kategori</th>               
                        <td><select name='b' class='form-control' required>
                          <option value='' selected>- Pilih Kategori -</option>";
                            foreach ($katber->result_array() as $row){
                              if ($berita['idkategori'] == $row['id_kategori']){
                        ...
                        <td><textarea id='editor1' class='form-control' name='d' style='height:320px' required>$berita[isi_berita]</textarea></td></tr>
                        <tr><th scope='row'>Ganti Gambar</th>                 
                        <td><input type='file' class='form-control' name='e'>";
                          if ($berita['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href='".base_url()."asset/berita/$berita[gambar]'>$berita[gambar]</a>"; } echo "</td></tr>
                        
                        <tr><th scope='row'>User</th>               
                        <td><input type='text' class='form-control' name='f' value='$users[nama_lengkap]' required readonly></td></tr>
                      </tbody>
                    </table>
                  </div>
                </div>
              ...
              <div class='col-md-12'>
                <div class='box box-danger'>
                  <div class='box-header with-border'>
                    <h3 class='box-title'>Edit Selected News</h3>
                    <br>
                ...
                <div class='box-body'>";
                  ...
                  echo "<div class='col-md-12'>
                    <table class='table table-condensed table-bordered'>
                      <tbody>
                      <input type='hidden' name='id' value='$berita[id_berita]'>
                        <tr><th width='120px' scope='row'>News Title</th>    
                        <td><input type='text' class='form-control' name='g' value='$berita2[judul_berita]' required></td></tr>
                        <tr><th scope='row'>Category</th>               
                        <td><select name='h' class='form-control' required>
                          <option value='' selected>- Select Category -</option>";
                            foreach ($katber2->result_array() as $row){
                              if ($berita2['idkategori'] == $row['id_kategori']){
                                echo "<option value='$row[id_kategori]' selected>$row[nama_kategori]</option>";
                              }else{
                                echo "<option value='$row[id_kategori]'>$row[nama_kategori]</option>";
                              }
                        ...
                        <td><textarea id='editor2' class='form-control' name='i' style='height:320px' required>$berita2[isi_berita]</textarea></td></tr>
                        <tr><th scope='row'>Change Image</th>                 
                        <td><input type='file' class='form-control' name='j'>";
                          if ($berita2['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href='".base_url()."asset/berita/$berita2[gambar]'>$berita2[gambar]</a>"; } echo "</td></tr>
                        
                        <tr><th scope='row'>User</th>               
                        <td><input type='text' class='form-control' name='m' value='$users[nama_lengkap]' required readonly></td></tr>
                      </tbody>
                    </table>
                  </div>
                </div>
            ...
            <div class='box-footer'>
                    ...
                    <a href='../berita'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
            </div>
            </div>"; ?>
        </section>

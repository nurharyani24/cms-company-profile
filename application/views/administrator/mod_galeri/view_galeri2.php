          ...
          <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  ...
                  <a class='pull-right btn btn-danger' href='<?php echo base_url(); ?>administrator/tambah_galeri'>Tambahkan Data</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              <td><a target='_BLANK' href='".base_url()."asset/img_galeri/$row[gambar]'>$row[gambar]</a></td>
                              <td>$row[judul_gambar]</td>
                              <td>$row[jdl_album]</td>
                              <td><center>
                                <a class='btn btn-success btn-xs' title='Edit Data' href='".base_url()."administrator/edit_galeri/$row[id_gambar]'><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."administrator/delete_galeri/$row[id_gambar]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>
                          </tr>";
                      $no++;
                    }

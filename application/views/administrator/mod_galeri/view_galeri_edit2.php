        ...
        <section class="content">
          <?php echo "<div class='col-md-12'>
              ...
              echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <input type='hidden' name='id' value='$galeri[id_gambar]'>
                    <tr><th width='120px' scope='row'>Album</th>      
                    <td><select name='a' class='form-control' required>
                      <option value='' selected>- Pilih Album -</option>";
                        foreach ($select_album->result_array() as $row){
                          if ($galeri['id_album']==$row['id_album']){
                    ...
                    echo "</td></tr>
                    <tr><th scope='row'>Judul Foto</th>               
                    <td><input type='text' class='form-control' name='b' value='$galeri[judul_gambar]'></td></tr>
                    <tr><th scope='row'>Ganti Gambar</th>                    
                    <td><input type='file' class='form-control' name='d'><hr style='margin:5px'>";
                      if ($galeri['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href='".base_url()."asset/img_galeri/$galeri[gambar]'>$galeri[gambar]</a>"; } echo "</td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
          ...
          <div class='col-md-12'>
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Photo Gallery</h3>
                  <br>
              ...
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$galeri2[id_gambar]'>
                    <tr><th width='120px' scope='row'>Album</th>      
                    <td><select name='z' class='form-control' required>
                      <option value='' selected>- Select Album -</option>";
                        foreach ($select_album2->result_array() as $row){
                          if ($galeri2['id_album']==$row['id_album']){
                            echo "<option value='$row[id_album]' selected>$row[jdl_album]</option>";
                          }else{
                            echo "<option value='$row[id_album]'>$row[jdl_album]</option>";
                          }
                    ...
                    echo "</td></tr>
                    <tr><th scope='row'>Photo Title</th>               
                    <td><input type='text' class='form-control' name='y' value='$galeri2[judul_gambar]'></td></tr>
                    <tr><th scope='row'>Change Image</th>                    
                    <td><input type='file' class='form-control' name='x'><hr style='margin:5px'>";
                      if ($galeri2['gambar'] != ''){ echo "<i style='color:red'>View current image : </i><a target='_BLANK' href='".base_url()."asset/img_galeri/$galeri2[gambar]'>$galeri2[gambar]</a>"; } echo "</td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
            ...
            <div class='box-footer'>
                    ...
                    <a href='../galeri'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>

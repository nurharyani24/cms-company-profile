            ...
            <?php 
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Berita RUPS Baru</h3>
                  <p style='color: red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/tambah_berita_rups',$attributes); 
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='120px' scope='row'>ID RUPS<span style='color : red'> *</span></th>
                    <td><input type='number' class='form-control' name='a' required></td></tr>

                    <tr><th width='120px' scope='row'>ID Judul<span style='color : red'> *</span></th>
                    <td><select name='b' class='form-control' required>
                      <option value='' selected>- Pilih Judul -</option>";
                      foreach ($jdl_rups->result_array() as $row){
                        echo "<option value='$row[id_judul]'>$row[judul]</option>";
                      }
                    echo "</td></tr>
                    
                    <tr><th scope='row'>Keterangan<span style='color : red'> *</span></th>                 
                    <td><textarea class='form-control' name='c' style='height:260px'></textarea></td></tr>
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Input GSM News</h3>
              ...
              echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Title ID<span style='color : red'> *</span></th>
                    <td><select name='f' class='form-control' required>
                      <option value='' selected>- select a title -</option>";
                      foreach ($jdl_rups_en->result_array() as $row){
                        echo "<option value='$row[id_judul]'>$row[judul]</option>";
                      }
                    echo "</td></tr>
                    
                    <tr><th scope='row'>Remark<span style='color : red'> *</span></th>                 
                    <td><textarea class='form-control' name='g' style='height:260px'></textarea></td></tr>

        ...
        <section class="content">
          ...
          "<div class='col-md-12'>
              ...
              echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <input type='hidden' name='id' value='$ambil[id_sub]'>
                    <tr><th width='120px' scope='row'>Sub Menu</th>  
                    <td><input type='text' class='form-control' name='a' value='$ambil[nama_sub]'></td></tr>
                    <tr><th scope='row'>Menu Utama</th>              
                    <td><select name='b' class='form-control'>
                      <option value='0' selected>- Pilih Menu Utama -</option>";
                        foreach ($utama->result_array() as $row){
                          if ($ambil['id_main']==$row['id_main']){
                    ...
                    <td><input type='text' class='form-control' name='d' value='$ambil[link_sub]'></td></tr>
            ...
            <div class='box box-danger'>
              ...
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$ambil_en[id_sub]'>
                    <tr><th width='120px' scope='row'>Sub Menu</th>  
                    <td><input type='text' class='form-control' name='g' value='$ambil_en[nama_sub]'></td></tr>
                    <tr><th scope='row'>Main Menu</th>              
                    <td><select name='h' class='form-control'>
                      <option value='0' selected>- Choose Main Menu -</option>";
                        foreach ($utama_en->result_array() as $row){
                          if ($ambil_en['id_main']==$row['id_main']){
                            echo "<option value='$row[id_main]' selected>$row[nama_menu]</option>";
                          }else{
                            echo "<option value='$row[id_main]'>$row[nama_menu]</option>";
                          }
                    ...
                    <tr><th scope='row'>Link Sub Menu</th>            
                    <td><input type='text' class='form-control' name='i' value='$ambil_en[link_sub]'></td></tr>
                    <tr><th scope='row'>Active</th>                  
                    <td>"; if ($ambil_en['aktif'] == 'Y'){

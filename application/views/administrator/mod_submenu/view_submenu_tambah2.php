    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='125px' scope='row'>Sub Menu<span style='color : red'> *</span></th>  
                    <td><input type='text' class='form-control' name='a'></td></tr>
                    <tr><th scope='row'>Menu Utama<span style='color : red'> *</span></th>              
                    <td><select name='b' class='form-control'>
                      <option value='0' selected>--- Menu Tampilan Web ---</option>";
                      foreach ($utama->result_array() as $row){
                        if($row['link']=='' && $row['aktif']=='Y'){
                          echo "<option value='$row[id_main]'>$row[nama_menu]</option>";
                        }
                      }
                      echo "<option value='0'>--- Menu Tampilan CMS ---</option>";
                      foreach ($utama->result_array() as $row){
                        if($row['admin_menu']=='Y'){
                          echo "<option value='$row[id_main]'>$row[nama_menu]</option>";
                        }
                    ...
                    <tr><th scope='row'>Admin Sub Menu<span style='color : red'> *</span></th>           
              ...
              echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Main Menu<span style='color : red'> *</span></th>              
                    <td><select name='h' class='form-control'>
                      <option value='0' selected>--- Web Intercafe Menu ---</option>";
                      foreach ($utama_en->result_array() as $row){
                        if($row['link']=='' && $row['aktif']=='Y'){
                          echo "<option value='$row[id_main]'>$row[nama_menu]</option>";
                        }
                      }
                      echo "<option value='0'>--- CMS Interface Menu ---</option>";
                      foreach ($utama_en->result_array() as $row){
                        if($row['admin_menu']=='Y'){
                          echo "<option value='$row[id_main]'>$row[nama_menu]</option>";
                        }
                    ...
                    <td><input type='radio' name='j' value='Y' checked> Y <input type='radio' name='j' value='N'> N</td></tr>
                    <tr><th scope='row'>Admin Sub Menu<span style='color : red'> *</span></th>           
                    <td><input type='radio' name='k' value='Y'> Y <input type='radio' name='k' value='N' checked> N</td></tr>
                  </tbody>
                  </table>
                </div>
              </div>

        ...
        <section class="content">
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <a class='pull-right btn btn-danger' href='<?php echo base_url(); ?>administrator/tambah_halamanbaru'>Tambahkan Data</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$tgl_posting</td>
                              <td><a target='_BLANK' href='".base_url()."asset/foto_halaman/$row[gambar]'>$row[gambar]</a></td>
                              <td><center>
                                <a class='btn btn-success btn-xs' title='Edit Data' href='".base_url()."administrator/edit_halamanbaru/$row[id_halstatis]'><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."administrator/delete_halamanbaru/$row[id_halstatis]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>
                          </tr>";
                      $no++;
                    }

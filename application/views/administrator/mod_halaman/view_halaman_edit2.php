        ...
        <section class="content">
          <?php 
              ...
              echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <input type='hidden' name='id' value='$hal_statis[id_halstatis]'>
                    <tr><th width='120px' scope='row'>Judul</th>   
                    <td><input type='text' class='form-control' name='a' value='$hal_statis[judul_halaman]'></td></tr>
                    <tr><th scope='row'>Isi Halaman</th>                 
                    <td><textarea id='editor1' class='form-control' name='b' style='height:320px'>$hal_statis[isi_halaman]</textarea></td></tr>
                    <tr><th scope='row'>Ganti Gambar</th>                    
                    <td><input type='file' class='form-control' name='c'><hr style='margin:5px'>";
                        if ($hal_statis['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href='".base_url()."asset/foto_halaman/$hal_statis[gambar]'>$hal_statis[gambar]</a>"; } echo "</td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
              ...
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$hal_statis2[id_halstatis]'>
                    <tr><th width='120px' scope='row'>Title</th>   
                    <td><input type='text' class='form-control' name='z' value='$hal_statis2[judul_halaman]'></td></tr>
                    <tr><th scope='row'>Page Content</th>                 
                    <td><textarea id='editor2' class='form-control' name='y' style='height:320px'>$hal_statis2[isi_halaman]</textarea></td></tr>
                    <tr><th scope='row'>Change Image</th>                    
                    <td><input type='file' class='form-control' name='x'><hr style='margin:5px'>";
                        if ($hal_statis2['gambar'] != ''){ echo "<i style='color:red'>View current page : </i><a target='_BLANK' href='".base_url()."asset/foto_halaman/$hal_statis2[gambar]'>$hal_statis2[gambar]</a>"; } echo "</td></tr>
                  </tbody>
                  </table>
                </div>
              </div>

      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/tambah_dokber',$attributes); 
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='120px' scope='row'>ID Dokumen<span style='color : red'> *</span></th>
                    ...
                    <tr><th width='120px' scope='row'>Judul Berita<span style='color : red'> *</span></th> 

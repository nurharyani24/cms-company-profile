    ...
    echo "<div class='col-md-12'>
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Dokumen Baru</h3>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <td><input type='number' class='form-control' name='o' required></td></tr>
                    

                    <tr><th width='120px' scope='row'>Judul</th> 
                    <td><input type='text' class='form-control' name='a' required></td></tr>
                    
                    <tr><th scope='row'>Kategori<span style='color : red'> *</span></th>               
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <td><input type='text' class='form-control' name='f' required></td></tr>
                    
                    <tr><th scope='row'>Category<span style='color : red'> *</span></th>               
                    <td><select name='g' class='form-control' required>

                      <option value='' selected>- select a category -</option>";
                        foreach ($dokumen_en->result_array() as $row){
                          echo "<option value='$row[id_kategoridokumen]'>$row[nama_kategori]</option>";
                        }
                    echo "</td></tr>
                    ...
                    <tr><th scope='row'>User</th>               
                    <td><input type='text' class='form-control' name='z' value='$users[nama_lengkap]' required readonly></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>

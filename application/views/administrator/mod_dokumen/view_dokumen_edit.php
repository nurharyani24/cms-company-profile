    ...
    echo "<div class='col-md-12'>
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Dokumen Terpilih</h3>
                  <br>
              ...
              echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <input type='hidden' name='id' value='$dok[id_dokumen]'>
                    <tr><th width='120px' scope='row'>Judul</th>    
                    <td><input type='text' class='form-control' name='a' value='$dok[judul_dokumen]' required></td></tr>
                    
                    <tr><th scope='row'>Kategori</th>               
                    <td><select name='b' class='form-control' required>
                      <option value='' selected>- Pilih Kategori -</option>";
                        foreach ($katdok->result_array() as $row){
                          if ($dok['id_kategoridokumen'] == $row['id_kategoridokumen']){
                            echo "<option value='$row[id_kategoridokumen]' selected>$row[nama_kategori]</option>";
                          }else{
                            echo "<option value='$row[id_kategoridokumen]'>$row[nama_kategori]</option>";
                          }
                        }
                    echo "</td></tr>
                    <tr><th scope='row'>Ganti Dokumen</th>                 
                    <td><input type='file' class='form-control' name='e'>";
                      if ($dok['dokumen'] != ''){ echo "<i style='color:red'>Lihat Dokumen Saat ini : </i><a target='_BLANK' href='".base_url()."asset/dokumen/$dok[dokumen]'>$dok[dokumen]</a>"; } echo "</td></tr>
                    
                    <tr><th scope='row'>User</th>               
                    <td><input type='text' class='form-control' name='u' value='$users[nama_lengkap]' required readonly></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Selected Document</h3>
                  <br>
              ...
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$dok_en[id_dokumen]'>
                    <tr><th width='120px' scope='row'>Title</th>    
                    <td><input type='text' class='form-control' name='z' value='$dok_en[judul_dokumen]' required></td></tr>
                    
                    <tr><th scope='row'>Category</th>               
                    <td><select name='y' class='form-control' required>
                      <option value='' selected>- Select Category -</option>";
                        foreach ($katdok_en->result_array() as $row){
                          if ($dok_en['id_kategoridokumen'] == $row['id_kategoridokumen']){
                            echo "<option value='$row[id_kategoridokumen]' selected>$row[nama_kategori]</option>";
                          }else{
                            echo "<option value='$row[id_kategoridokumen]'>$row[nama_kategori]</option>";
                          }
                    ...
                    <td><input type='file' class='form-control' name='x'>";
                      if ($dok_en['dokumen'] != ''){ echo "<i style='color:red'>View current document : </i><a target='_BLANK' href='".base_url()."asset/dokumen/$dok_en[dokumen]'>$dok_en[dokumen]</a>"; } echo "</td></tr>
                    
                    <tr><th scope='row'>User</th>               
                    <td><input type='text' class='form-control' name='w' value='$users[nama_lengkap]' required readonly></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
            ...
            <div class='box-footer'>
                    ...
                    <a href='../dokumen'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
            </div>
          </div>"; ?>
        </section>

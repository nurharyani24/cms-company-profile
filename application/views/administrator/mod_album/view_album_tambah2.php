        ...
        <section class="content">
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Nama Album<span style='color : red'> *</span></th>    
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <input type='hidden' name='id' value=''>
                    <tr><th width='120px' scope='row'>Album's Name<span style='color : red'> *</span></th>    
                    <td><input type='text' class='form-control' name='z' required></td></tr>

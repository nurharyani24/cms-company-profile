        ...
        <?php 
          echo "<div class='col-md-12'>
                    <div class='box box-danger'>
                      ...
                      <div class='box-body'>";
                        ...
                        <tbody>
                          ...
                          <tr><th width='120px' scope='row'>Judul Album</th>       
                          <td><input type='text' class='form-control' name='a' value='$album[jdl_album]'></td></tr>
                        </tbody>
                        </table>
                      </div>
                    </div>
                ...
                <div class='col-md-12'>
                    <div class='box box-danger'>
                      ...
                      <div class='box-body'>";
                        ...
                        <table class='table table-condensed table-bordered'>
                        <tbody>
                          <input type='hidden' name='id' value='$album_en[id_album]'>
                          <tr><th width='120px' scope='row'>Album's Title</th>       
                          <td><input type='text' class='form-control' name='z' value='$album_en[jdl_album]'></td></tr>
                        </tbody>
                        </table>
                      </div>
                    </div>
                ...
                <div class='box-footer'>
                  ...
                  <a href='../album'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
                </div>
                </div>"; ?>
          </section>

          ...
          <?php 
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Judul Tanggung Jawab Sosial</h3>
                  <br>
                        <p style='color:red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/edit_jdl_tanggungjwb',$attributes); 
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$jdl[id_judul]'>

                    <tr><th width='120px' scope='row'>Judul</th>   
                    <td><input type='text' class='form-control' name='b' value='$jdl[judul]'></td></tr>

                    <tr><th scope='row'>Tempat Kegiatan</th>                 
                    <td><input type='text' class='form-control' name='c' value='$jdl[tempat]'></td></tr>
                    
                    <tr><th scope='row'>Tanggal Kegiatan</th>                 
                    <td><input type='text' class='form-control' name='d' value='$jdl[tanggal]'></td></tr>
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Selected Title of Social Corporate Responsibility</h3>
                  <br>
              ...
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$jdl_en[id_judul]'>

                    <tr><th width='120px' scope='row'>Title</th>   
                    <td><input type='text' class='form-control' name='z' value='$jdl_en[judul]'></td></tr>

                    <tr><th scope='row'>Place of activity</th>                 
                    <td><input type='text' class='form-control' name='y' value='$jdl_en[tempat]'></td></tr>
                    
                    <tr><th scope='row'>Date of Activity</th>                 
                    <td><input type='text' class='form-control' name='x' value='$jdl_en[tanggal]'></td></tr>
            ...
            <div class='box-footer'>
                    ...
                    <a href='../jdl_tanggungjwb'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
            </div>
            </div>"; ?>
        </section>

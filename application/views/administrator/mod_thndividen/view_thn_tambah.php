          ...
          <?php echo "<div class='col-md-12'>
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Tahun Dividen</h3>
                  <p style='color: red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/tambah_thn_dividen',$attributes); 
              ...
              <div class='box-footer'>
                    ...
                    <a href='thn_dividen'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>

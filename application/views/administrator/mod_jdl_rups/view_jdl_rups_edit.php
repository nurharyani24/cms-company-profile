          ...
          <?php 
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Judul RUPS</h3>
                  <br>
                        <p style='color:red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/edit_jdl_rups',$attributes); 
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$jdl_rups[id_judul]'>

                    <tr><th width='120px' scope='row'>Judul</th>   
                    <td><input type='text' class='form-control' name='b' value='$jdl_rups[judul]'></td></tr>
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit GMS Title</h3>
                  <br>
              ...
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$jdl_rups_en[id_judul]'>

                    <tr><th width='120px' scope='row'>Title</th>   
                    <td><input type='text' class='form-control' name='z' value='$jdl_rups_en[judul]'></td></tr>
            ...
            <div class='box-footer'>
                    ...
                    <a href='../jdl_rups'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>

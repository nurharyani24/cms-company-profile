            ...
            <?php 
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Berita Dividen Baru</h3>
                  <p style='color: red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/tambah_isi_dividen',$attributes); 
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='120px' scope='row'>ID Dividen<span style='color : red'> *</span></th>
                    <td><input type='number' class='form-control' name='a' required></td></tr>

                    <tr><th scope='row'>Tahun<span style='color : red'> *</span></th>               
                    ...
                    <tr><th width='120px' scope='row'>Total dividen yang dibagikan<span style='color : red'> *</span></th>
                    <td><input type='text' class='form-control' name='c' required></td></tr>

                    <tr><th width='120px' scope='row'>Jumlah dividen kas per saham<span style='color : red'> *</span></th>
                    <td><input type='text' class='form-control' name='d' required></td></tr>

                    <tr><th width='120px' scope='row'>Payout ratio<span style='color : red'> *</span></th>
                    <td><input type='text' class='form-control' name='e' required></td></tr>

                    <tr><th width='120px' scope='row'>Tanggal pengumuman<span style='color : red'> *</span></th>
                    <td><input type='date' class='form-control' name='f' required></td></tr>

                    <tr><th width='120px' scope='row'>Tanggal pembagian dividen<span style='color : red'> *</span></th>
                    <td><input type='date' class='form-control' name='g' required></td></tr>
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Insert Dividend News</h3>
              ...
              echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Year<span style='color : red'> *</span></th>               
                    <td><select name='i' class='form-control' required>
                    ...
                    <tr><th width='120px' scope='row'>Total dividend distributed<span style='color : red'> *</span></th>
                    <td><input type='text' class='form-control' name='j' required></td></tr>

                    <tr><th width='120px' scope='row'>Cash dividend per share<span style='color : red'> *</span></th>
                    <td><input type='text' class='form-control' name='k' required></td></tr>

                    <tr><th width='120px' scope='row'>Payout ratio<span style='color : red'> *</span></th>
                    <td><input type='text' class='form-control' name='l' required></td></tr>

                    <tr><th width='120px' scope='row'>Date of announcement<span style='color : red'> *</span></th>
                    <td><input type='date' class='form-control' name='m' required></td></tr>

                    <tr><th width='120px' scope='row'>Date of dividend distribution<span style='color : red'> *</span></th>
                    <td><input type='date' class='form-control' name='n' required></td></tr>

      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            echo "<div class='col-md-12'>
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Dividen Terpilih</h3>
                  <br>
                        <p style='color:red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/edit_isi_dividen',$attributes); 
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$dividen[id_dividen]'>
                    ...
                    <tr><th width='120px' scope='row'>Total dividen yang dibagikan</th>
                    <td><input type='text' class='form-control' name='c' value=$dividen[total_dividen] required></td></tr>

                    <tr><th width='120px' scope='row'>Jumlah dividen kas per saham</th>
                    <td><input type='text' class='form-control' name='d' value=$dividen[jml_dividen] required></td></tr>

                    <tr><th width='120px' scope='row'>Payout ratio</th>
                    <td><input type='text' class='form-control' name='e' value=$dividen[payout] required></td></tr>

                    <tr><th width='120px' scope='row'>Tanggal pengumuman</th>
                    <td><input type='date' class='form-control' name='f' value=$dividen[tgl_pengumuman] required></td></tr>

                    <tr><th width='120px' scope='row'>Tanggal pembagian dividen</th>
                    <td><input type='date' class='form-control' name='g' value=$dividen[tgl_pembagian] required></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Selected Dividend</h3>
                  <br>
              ...
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$dividen_en[id_dividen]'>

                    <tr><th scope='row'>Year</th>               
                    <td><select name='z' class='form-control'>
                    <option value='0' selected>- Select Year -</option>";
                      foreach ($thn->result_array() as $row){
                        if ($dividen_en['id_dividen']==$row['id_dividen']){
                          echo "<option value='$row[id_dividen]' selected>$row[tahun]</option>";
                        }else{
                          echo "<option value='$row[id_dividen]'>$row[tahun]</option>";
                        }
                      }
                    echo "</td></tr>

                    <tr><th width='120px' scope='row'>Total dividend distributed</th>
                    <td><input type='text' class='form-control' name='y' value=$dividen_en[total_dividen] required></td></tr>

                    <tr><th width='120px' scope='row'>Cash dividend per share</th>
                    <td><input type='text' class='form-control' name='x' value=$dividen_en[jml_dividen] required></td></tr>

                    <tr><th width='120px' scope='row'>Payout ratio</th>
                    <td><input type='text' class='form-control' name='w' value=$dividen_en[payout] required></td></tr>



                    <tr><th width='120px' scope='row'>Date of announcement</th>
                    <td><input type='date' class='form-control' name='v' value=$dividen_en[tgl_pengumuman] required></td></tr>

                    <tr><th width='120px' scope='row'>Date of dividend distribution</th>
                    <td><input type='date' class='form-control' name='u' value=$dividen_en[tgl_pembagian] required></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
            ...
            <div class='box-footer'>
                    ...
                    <a href='../isi_dividen'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
            </div>
            </div>"; ?>
        </section>

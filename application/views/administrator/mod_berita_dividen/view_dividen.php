          ...
          <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Semua Isi Dividen</h3>
                  <a class='pull-right btn btn-danger' href='<?php echo base_url(); ?>administrator/tambah_isi_dividen'>Tambahkan Data</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th>Tahun</th>
                        <th>Total dividen yang dibagikan</th>
                        <th>Jumlah dividen kas per saham</th>
                        <th>Payout ratio</th>
                        <th>Tanggal pengumuman</th>
                        <th>Tanggal pembagian dividen</th>
                  ...
                  <?php 
                    $no = 1;
                    foreach ($dividen->result_array() as $row){
                    
                    echo "<tr><td>$no</td>
                              <td>$row[tahun]</td>
                              <td>$row[total_dividen]</td>
                              <td>$row[jml_dividen]</td>
                               <td>$row[payout]</td>
                              <td>$row[tgl_pengumuman]</td>
                              <td>$row[tgl_pembagian]</td>
                              <td><center>
                                <a class='btn btn-success btn-xs' title='Edit Data' href='".base_url()."administrator/edit_isi_dividen/$row[id_dividen]'><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."administrator/delete_isi_dividen/$row[id_dividen]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>
                          </tr>";
                      $no++;
                    }

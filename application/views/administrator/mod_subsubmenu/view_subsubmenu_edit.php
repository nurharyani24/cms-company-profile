          ...
          "<div class='col-md-12'>
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Sub Submenu</h3>
                  <p style='color:red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/edit_subsubmenu',$attributes); 
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$taroh[id_subsub]'>
                    <tr><th width='120px' scope='row'>Sub Submenu</th>  
                    <td><input type='text' class='form-control' name='a' value='$taroh[nama_subsub]'></td></tr>
                    <tr><th scope='row'>Sub Menu</th>              
                    <td><select name='b' class='form-control'>
                      <option value='0' selected>- Pilih Sub Menu -</option>";
                        foreach ($submenu->result_array() as $row){
                          if ($taroh['idsub']==$row['id_sub']){
                    ...
                    <tr><th scope='row'>Link Sub Submenu</th>            
                    <td><input type='text' class='form-control' name='d' value='$taroh[link_subsub]'></td></tr>
                    ...
                    echo "</td></tr>
                    <tr><th scope='row'>Admin Sub Menu</th><td>"; 
                    if ($taroh['admin_subsubmenu'] == 'Y'){
            ...
            <div class='box box-danger'>
              ...
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$taroh_en[id_subsub]'>
                    <tr><th width='120px' scope='row'>Sub Submenu</th>  
                    <td><input type='text' class='form-control' name='g' value='$taroh_en[nama_subsub]'></td></tr>
                    <tr><th scope='row'>Sub Menu</th>              
                    <td><select name='h' class='form-control'>
                      <option value='0' selected>- Choose Sub Menu -</option>";
                        foreach ($submenu_en->result_array() as $row){
                          if ($taroh_en['idsub']==$row['id_sub']){
                            echo "<option value='$row[id_sub]' selected>$row[nama_sub]</option>";
                          }else{
                            echo "<option value='$row[id_sub]'>$row[nama_sub]</option>";
                          }
                    ...
                    <tr><th scope='row'>Link Sub Menu</th>            
                    <td><input type='text' class='form-control' name='i' value='$taroh_en[link_subsub]'></td></tr>
                    <tr><th scope='row'>Active</th>                  
                    <td>"; if ($taroh_en['aktif'] == 'Y'){
                      echo "<input type='radio' name='j' value='Y' checked> Y 
                        <input type='radio' name='j' value='N'> N";
                          }else{
                            echo "<input type='radio' name='j' value='Y'> Y 
                            <input type='radio' name='j' value='N' checked> N";
                          }
                    echo "</td></tr>
                    <tr><th scope='row'>Admin Sub Menu</th><td>"; 
                    if ($taroh_en['admin_subsubmenu'] == 'Y'){
                      echo "<input type='radio' name='k' value='Y' checked> Y 
                        <input type='radio' name='k' value='N'> N";
                        }else{
                          echo "<input type='radio' name='k' value='Y'> Y 
                          <input type='radio' name='k' value='N' checked> N";
                        }
                    echo "</td></tr>
                  </tbody>
                  </table>
            ...
            <div class='box-footer'>
                    ...
                    <a href='../subsubmenu'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>

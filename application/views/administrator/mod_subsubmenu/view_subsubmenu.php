        ...
        <section class="content">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Sub Submenu</h3>
                  <a class='pull-right btn btn-danger' href='<?php echo base_url(); ?>administrator/tambah_subsubmenu'>Tambahkan Data</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th>Sub Submenu</th>
                        <th>Sub Menu</th>
                        <th>Link Sub Submenu</th>
                        <th>Aktif</th>
                        <th>Admin Sub Submenu</th>
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              <td>$row[nama_subsub]</td>
                              <td>$row[nama_sub]</td>
                              <td><a target='_BLANK' href='".base_url()."$row[link_subsub]'>$row[link_subsub]</a></td>
                              <td>$row[aktif]</td>
                              <td>$row[admin_subsubmenu]</td>
                              <td><center>
                                <a class='btn btn-success btn-xs' title='Edit Data' href='".base_url()."administrator/edit_subsubmenu/$row[id_subsub]'><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."administrator/delete_subsubmenu/$row[id_subsub]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>
                          </tr>";
                      $no++;
                    }

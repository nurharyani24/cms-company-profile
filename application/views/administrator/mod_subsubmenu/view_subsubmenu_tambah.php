        ...
        echo "<div class='col-md-12'>
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Sub Submenu</h3>
                  <p style='color: red'>Indonesia</p>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/tambah_subsubmenu',$attributes); 
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value=''>
                    <tr><th width='150px' scope='row'>Sub Submenu<span style='color : red'> *</span></th>  
                    <td><input type='text' class='form-control' name='a'></td></tr>
                    <tr><th scope='row'>Sub Menu<span style='color : red'> *</span></th>              
                    ...
                    <tr><th scope='row'>Aktif<span style='color : red'> *</span></th>                    
                    <td><input type='radio' name='e' value='Y' checked> Y <input type='radio' name='e' value='N'> N</td></tr>
                    <tr><th scope='row'>Admin Sub Submenu<span style='color : red'> *</span></th>           
                    <td><input type='radio' name='f' value='Y'> Y <input type='radio' name='f' value='N' checked> N</td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
              ...
              <div class='box box-danger'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Add Sub Submenu</h3>
              ...
              echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <input type='hidden' name='id' value=''>
                    <tr><th width='150px' scope='row'>Sub Submenu<span style='color : red'> *</span></th>  
                    <td><input type='text' class='form-control' name='g'></td></tr>
                    <tr><th scope='row'>Sub Menu<span style='color : red'> *</span></th>              
                    <td><select name='z' class='form-control'>
                      <option value='0' selected>- select sub menu -</option>";
                    ...
                    <tr><th scope='row'>Link Sub Submenu</th>            
                    <td><input type='text' class='form-control' name='h'></td></tr>
                    <tr><th scope='row'>Active<span style='color : red'> *</span></th>                    
                    <td><input type='radio' name='i' value='Y' checked> Y <input type='radio' name='i' value='N'> N</td></tr>
                    <tr><th scope='row'>Admin Sub Submenu<span style='color : red'> *</span></th>           
                    <td><input type='radio' name='j' value='Y'> Y <input type='radio' name='j' value='N' checked> N</td></tr>
                  </tbody>
                  </table>
                </div>
              </div>

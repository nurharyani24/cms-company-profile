...
<html>
  ...
  .sekolah:hover{
    ...
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/edit_kategoridokumen',$attributes); 
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$dokumen[id_kategoridokumen]'>
                    <tr><th width='120px' scope='row'>Nama Kategori</th>    
                    <td><input type='text' class='form-control' name='a' value='$dokumen[nama_kategori]' required></td></tr>
            ...
            <div class='box box-danger'>
              ...
              echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$dokumen_en[id_kategoridokumen]'>
                    <tr><th width='120px' scope='row'>Category Name</th>    
                    <td><input type='text' class='form-control' name='c' value='$dokumen_en[nama_kategori]' required></td></tr>
            ...
            <div class='box-footer'>
                    ...
                    <a href='../kategoridokumen'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
            </div>
         </div>"; ?>
        </section>

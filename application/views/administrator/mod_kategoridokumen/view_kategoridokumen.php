        ...
        <section class="content">
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <a class='pull-right btn btn-danger' href='<?php echo base_url(); ?>administrator/tambah_kategoridokumen'>Tambahkan Data</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$row[aktif]</td>
                              <td><center>
                                <a class='btn btn-success btn-xs' title='Edit Data' href='".base_url()."administrator/edit_kategoridokumen/$row[id_kategoridokumen]'><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."administrator/delete_kategoridokumen/$row[id_kategoridokumen]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>
                          </tr>";
                      $no++;
                    }

  ...
  .sekolah:hover{
    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <input type='hidden' name='id' value='$katber[id_kategori]'>
                    <tr><th width='120px' scope='row'>Nama Kategori</th>    <td><input type='text' class='form-control' name='a' value='$katber[nama_kategori]' required></td></tr>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <input type='hidden' name='id' value='$katber[id_kategori]'>
                    <tr><th width='120px' scope='row'>Category's Name</th>    
                    <td><input type='text' class='form-control' name='z' value='$katber_en[nama_kategori]' required></td></tr>

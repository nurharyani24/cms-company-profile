...
<div id="responsive1">
    ...
    <div id="banner_web_in">
      <?php
              foreach ($gambarpemsaham->result_array() as $row) {
                    $foto = $row['gambar'];
...
<div id="isi">
    ...
    <div style="padding-bottom:25px;">
      <img src="<?=base_url()?>images/dot.jpg" width="17" height="14" align="left" style="padding-right:20px;padding-top:8px;"/>
        <?php
              foreach ($judulpemsaham->result_array() as $row) {
      ...
      <?php
      echo "<img src='".base_url()."asset/img_galeri/$gambar[gambar]' width='800' height='434' alt='Struktur Pemegang Saham MDIA'/>"
      ?>

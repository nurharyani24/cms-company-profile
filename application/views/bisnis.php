...
<div id="responsive1">
      <?php include("head.php"); ?>
        ...
        <?php
            foreach ($gambarbisnis->result_array() as $row) {
                $foto = $row['gambar'];
...
<div id="isi">
    ...
    <div style="padding-bottom:25px;">
        ...
        <?php 
        foreach ($judulbisnis->result_array() as $row) {
    ...
    <?php 
            foreach ($isibisnis->result_array() as $row) {
 ...
 <?php 
        foreach ($transbisnis->result_array() as $row) {
            $foto = $row['gambar'];

...
<div id="responsive1">
    ...
    <div id="banner_web_in">
    	<?php
            foreach ($gambarpapub_en->result_array() as $row) {
                $foto = $row['gambar'];
...
<div id="isi">
    ...
    <div style="padding-bottom:25px;">
        ...
        <?php 
        foreach ($judulpapub_en->result_array() as $row) {
    ...
    <table>
      ...
      <?php 
        foreach ($beritapapub_en->result_array() as $row) {
            echo "<tr>";  
            ...
            echo "<img src='".base_url()."images/pdficon.png"."' width='50px' height='50px' align='center'/></a>
                  </td>";
            echo "</tr>";
        }
        ?>

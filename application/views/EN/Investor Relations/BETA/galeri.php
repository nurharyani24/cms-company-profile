...
<link rel="stylesheet" href="CSR/css/lightbox.css" type="text/css" media="screen" />
	
	<script src="CSR/js/prototype.js" type="text/javascript"></script>
	<script src="CSR/js/scriptaculous.js?load=effects" type="text/javascript"></script>
	<script src="CSR/js/lightbox.js" type="text/javascript"></script>
...
<div id="content">
    ...
    <div style="padding-top:25px;">
    	<img src="images/dot.jpg" width="17" height="14" align="left" style="padding-left:50px; padding-right:20px;padding-top:12px;"/>
        <h1 class="judul">CSR</h1>
    </div>
        
		<div class="gallery"> 
        	<div> <span class="header"> Kegiatan Tahun 2015</span> </div>
            	<div align="center">
				<?php 
                $files = array();
                       ...
                       if( isset($files[$i]) && is_file( $src_folder .'/'. $files[$i] ) ) { 
                          ...
                          echo '<div class="thumb">
                                <a href="'. $src_folder .'/'. $files[$i] .'" class="albumpix" rel="lightbox">
                                   <img src="'. $src_folder .'/thumb/'. $files[$i] .'" width="'.$thumb_width.'" height="'.$thumb_height.'" alt="" />'.str_replace(".jpg","",$files[$i]).'
                                </a>
                                </div>';

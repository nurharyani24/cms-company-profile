...
class Komite_Manajemen_Resiko extends CI_Controller {
	...
	function index(){
        ...
        $data['gambarmresiko'] = $this->model_halaman->ambilresiko();
        $data['judulmresiko'] = $this->model_halaman->ambilresiko();
        $data['isimresiko'] = $this->model_halaman->ambilresiko();
	$this->load->view('komite_manajemen_resiko',$data);

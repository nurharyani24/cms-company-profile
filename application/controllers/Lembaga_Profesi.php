...
class Lembaga_Profesi extends CI_Controller {

	function index(){
        $data['judullembaga'] = $this->model_halaman->ambiljudullembaga();
        $data['judulprofesi'] = $this->model_berita->ambilprofesi();
	...
	$this->load->view('lembaga_profesi',$data);

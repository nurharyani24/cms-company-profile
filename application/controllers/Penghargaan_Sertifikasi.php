...
class Penghargaan_Sertifikasi extends CI_Controller {
	...
	$data['ikhtisar'] = $this->model_dokumen->dokumenikhtisar();
        ...
        $data['gambarpenghargaan'] = $this->model_halaman->ambilpenghargaan2();
        $data['judulpenghargaan'] = $this->model_halaman->ambilpenghargaan2();
        $data['pengser'] = $this->model_penghargaan->tahun_penghargaan();
        $data['peng'] = $this->model_penghargaan->ambilpenghargaan();
        $data['ser'] = $this->model_penghargaan->ambilsertifikasi();

...
class EN_Group_Structure extends CI_Controller {
    ...
    public function index()
	   {
        ...
        $data['judulstrgrp'] = $this->model_halaman->en_ambilstrgrp();
        ...
        $data['pemsaham_en'] = $this->model_dokumen->en_dokumensaham();
	   	...
	   	$data['gambar2'] = $this->model_galeri->en_struktur_grup();
        $this->load->view('EN/struktur-group',$data);
	   }

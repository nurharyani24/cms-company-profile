...
class Prospektus extends CI_Controller {
	...
	$data['ikhtisar'] = $this->model_dokumen->dokumenikhtisar();
        ...
        $data['judulpros'] = $this->model_halaman->ambilpros();
        $data['gambarpros'] = $this->model_halaman->ambilpros();
        $data['ambilpros'] = $this->model_berita->ambilberitapros();
        $data['ambildokumen'] = $this->model_dokber->ambildokumen();
	
        $this->load->view('prospektus',$data);

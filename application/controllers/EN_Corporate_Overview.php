...
class EN_Corporate_Overview extends CI_Controller {
    ...
    public function index()
	   {
        ...
        $data['pemsaham_en'] = $this->model_dokumen->en_dokumensaham();
	   	$data['gambarprofil'] = $this->model_halaman->en_ambilgambarprofil();
        $data['judulprofil'] = $this->model_halaman->en_ambiljudulprofil();
        $data['isiprofil'] = $this->model_halaman->en_ambilisiprofil();

        $this->load->view('EN/corporate-overview', $data);
	   }

...
class EN_Annual_Report extends CI_Controller {
    ...
    public function index()
	   {
        ...
        $data['laptah_en'] = $this->model_halaman->en_ambilberita();
        $data['laptah2_en'] = $this->model_berita->en_ambillaporanberita();
        $data['ambildokumen_en'] = $this->model_dokber->en_ambildokumen();
        $this->load->view('EN/annual-report',$data);
	   }

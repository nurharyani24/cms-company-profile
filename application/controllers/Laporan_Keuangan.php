...
class Laporan_Keuangan extends CI_Controller {
	...
	$data['ikhtisar'] = $this->model_dokumen->dokumenikhtisar();
        ...
        $data['gambarlapkeu'] = $this->model_halaman->ambillapkeu();
        $data['judullapkeu'] = $this->model_halaman->ambillapkeu();
        ...
        $data['lapkeu'] = $this->model_lapkeu->ambillapkeu();
        $data['dokumenlapkeu'] = $this->model_lapkeu->dokumenlapkeu();
        $data['ambildokumen'] = $this->model_lapkeu->ambildokumen();
        $data['dok'] = $this->model_lapkeu->ambildokumen();
        
        
        $this->load->view('informasi_keuangan',$data);

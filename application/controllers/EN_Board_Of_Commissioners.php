...
class EN_Board_Of_Commissioners extends CI_Controller {
    ...
    public function index()
	   {
        ...
        $data['pemsaham_en'] = $this->model_dokumen->en_dokumensaham();
	   	...
	   	$data['gambardekom'] = $this->model_halaman->en_ambildekom1();
        $data['juduldekom'] = $this->model_halaman->en_ambildekom1();
        $data['ambildekom1'] = $this->model_berita->en_ambildekom1();

        $this->load->view('EN/Board-Of-Commissioners',$data);
	   }
